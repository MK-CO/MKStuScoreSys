...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='课程表（旧版本）';
...
-- 新课程表数据
INSERT INTO `course` (`course_code`, `course_name`, `credits`, `course_type`, `department`, `teacher`, `capacity`, `enrolled`, `description`, `status`) VALUES
('CS101', '计算机科学导论', 3.0, 1, '计算机学院', '张教授', 120, 95, '计算机科学基础课程，介绍计算机科学的基本概念和原理。', 1),
('MATH201', '高等数学', 4.0, 1, '数学学院', '李教授', 150, 140, '数学基础课程，学习微积分等数学知识。', 1),
('ENG301', '学术英语', 2.0, 2, '外语学院', '王老师', 80, 65, '提高学术英语写作和表达能力。', 1),
('CS102', 'Java程序设计', 4.0, 1, '计算机学院', '张教授', 100, 85, 'Java编程语言基础与应用开发', 1),
('CS103', '数据库原理', 3.5, 1, '计算机学院', '刘教授', 90, 78, '数据库系统原理与SQL应用', 1),
('SE101', '软件工程', 3.0, 1, '软件学院', '陈教授', 80, 72, '软件开发生命周期与项目管理', 1),
('CS104', '计算机网络', 3.5, 1, '计算机学院', '王教授', 85, 68, '计算机网络协议与应用', 1),
('CS201', '数据结构与算法', 4.0, 1, '计算机学院', '李教授', 95, 82, '数据结构基础与算法设计', 1),
('CS202', '操作系统', 3.5, 1, '计算机学院', '赵教授', 88, 75, '操作系统原理与实现', 1),
('PHYS101', '大学物理', 3.0, 1, '物理学院', '孙教授', 120, 110, '物理学基础知识与实验', 1);
